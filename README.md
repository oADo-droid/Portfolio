...
Ce cadre me permet de travailler concrètement sur :
- la programmation événementielle ;
- la gestion d’états et de variables ;
- la logique client / serveur ;
- la structuration de scripts ;
- le débogage et l’amélioration progressive du code.
